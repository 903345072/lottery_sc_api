...
class plorderdetail extends StatefulWidget{
  int id;
  int type = 1;
  String f_or_b;
  plorderdetail(this.id,this.type,this.f_or_b);
  @override
...
class hangqing_ extends State<plorderdetail>{
  Map game ={};
  Map order= {"qh":"","content":"","caiguo":"未开奖","res":0};
  Map es = {};
  int chang;
  ...
  getFlowUser() async {
    ResultData res = await HttpManager.getInstance().get("getPlFlowUser",params: {"order_id":widget.id},withLoading: false);
    setState(() {
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        order["state"] == 2?Column(
                          ...
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: <Widget>[
                            Image.asset("img/yichupiao.png",fit: BoxFit.fill,width: 70),
                          ],
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        Wrap(
                          spacing: 5,
                          children: <Widget>[
                            Text(order["type"]==1?"直选普投":order["type"]==2?"组3复式":"组6普投",style: TextStyle(color: Colors.black),),
                      ...
                      children: [
                        ...
                        TableRow(
                            children: [
                              Container(
                                padding:EdgeInsets.only(top: 5,bottom: 5),
                                child: Text(order["type"]==1?"直选普投":order["type"]==2?"组3复式":"组6普投",textAlign: TextAlign.center,),
                              ),
                              Container(
                                padding:EdgeInsets.only(top: 5,bottom: 5),
                                         ...
                                         child: Row(
                                           ...
                                           children: <Widget>[
                                             ...
                                             Container(
                                               ...
                                               child: Text(order["type"]==1?"直选普投":order["type"]==2?"组3复式":"组6普投"),
                                             ),
                                             Container(
                                               height: ScreenUtil().setHeight(69),
                                               alignment: Alignment.center,
                                               width: ScreenUtil().setWidth(100),
                                               child: Text(order["qh"] != null?order["qh"]:""),
                                             ),
                                             Container(
                                               height: ScreenUtil().setHeight(69),
                                               alignment: Alignment.center,
                                             ...
                                             Container(
                                               ...
                                               child: Text(order["caiguo"],style: TextStyle(color: order["res"]==0?Colors.black:Colors.red),),
                                             ),
                                           ],
                                         ),
                                       )
