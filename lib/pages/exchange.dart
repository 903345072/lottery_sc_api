...
class exchange_ extends State<exchange> {
    ...
    getUserInfo() async{
        ...
        setState(() {
            now_money = double.parse(res.data["edu"].toString());
            flag = res.data["auto_order"];
        });
    }
    @override
                    ...
                    children: <Widget>[
                        Column(
                            ...
                            children: <Widget>[
                                ...
                                Container(
                                    margin: EdgeInsets.only(left: 5, top: 15, right: 5),
                                    child: flag == 1?Text("提示:跟单余额划转到余额",style: TextStyle(color: Colors.grey,fontSize: 12)):Text("提示:余额划转到购彩金",style: TextStyle(color: Colors.grey,fontSize: 12),),
                                )
